...
$('.databarang_ajax').selectator({
  ...
  load: function (search, callback) {
    ...
    $.ajax({
      url: 'http://localhost/klinikweb/admin/dokter_ralan/ajax?show=databarang&nama_brng=' + encodeURIComponent(search) + '&t=b67a9c8d1dae',
      type: 'GET',
      dataType: 'json',
...
function bersih(){
  ...
  $('input:text[name=tgl_perawatan]').val("2024-12-08");
  $('input:text[name=tgl_registrasi]').val("2024-12-08");
